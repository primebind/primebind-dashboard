...
type Format = "Image" | "Video" | "Carousel" | "Reel" | "Story";
...
const STATUS_COLORS: Record<Status, string> = {
  ...
  "To Test": "text-blue-400 bg-blue-400/10 border-blue-400/30",
  Testing: "text-yellow-400 bg-yellow-400/10 border-yellow-400/30",
  Winner: "text-green-400 bg-green-400/10 border-green-400/30",
  Cut: "text-red-400 bg-red-400/10 border-red-400/30",
};

const STATUSES: Status[] = ["Idea", "To Test", "Testing", "Winner", "Cut"];
const PLATFORMS: Platform[] = ["Meta", "TikTok", "Google", "Other"];
const FORMATS: Format[] = ["Image", "Video", "Carousel", "Reel", "Story"];

const EMPTY_FORM = { concept: "", platform: "Meta" as Platform, format: "Video" as Format, status: "Idea" as Status, notes: "" };
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Ad Ideas</h1>
          <p className="text-[#888] text-sm mt-1">Capture, track, and test creative concepts</p>
        </div>
        <button
        ...
        <div className="bg-[#111] border border-[#222] rounded-xl p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. Side-by-side binder damage comparison — ringless vs ring binder"
              value={form.concept}
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              placeholder="Hook, angle, script notes, reference accounts..."
              value={form.notes}
